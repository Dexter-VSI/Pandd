<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1" import="model.Video,java.util.List"%>
<!DOCTYPE html>
<html lang="en">
...
<!--       <h1 class="logo" style="opacity: 0"><a href="index.jsp" style="color:skyblue;font-size: 20px" >Pusegaonkar</a>
      ...
      <nav class="nav-menu d-none d-lg-block ml-auto">
        ...
        <ul>
          ...
          <li class="drop-down a active"><a href="#">Blog</a>
                <ul>
  ...
  <main id="main">
    ...
    <section id="contact" class="contact">
      <div class="container">
         ...
         List<List<String>> VideoDbList=videoObj.getVideoDbOutterList();
         if(VideoDbList != null)
         {
        ...
        <%  for(List<String> innerList : VideoDbList)
  ...
  for(int i=0;i<1;i++)
   {%>
        ...
        <div class="embed-responsive embed-responsive-4by3">
         <iframe class="embed-responsive-item" src="<%=myArray[2]%>" style="height:100%;width: 100%" allowfullscreen></iframe>
        ...
        <div class="col-lg-6 mt-5 mt-lg-0">
            <div class="info">
              ...
              <div class="entry-meta">
                <ul class="row">
                  ...
                  <li class="d-flex align-items-center" style="padding-left: 10px"><i class="icofont-calendar"></i> <a href="blog-single.html"><time datetime="2020-01-01"><%=myArray[4] %></time></a></li>
                </ul>
              </div>
           ...
           <%=myArray[3]%>
              ...
              <!--   <div class="read-more">
                  <a href="blog-single.html" style="padding-left: 35px">Read More</a>
                </div> -->
              </div>
