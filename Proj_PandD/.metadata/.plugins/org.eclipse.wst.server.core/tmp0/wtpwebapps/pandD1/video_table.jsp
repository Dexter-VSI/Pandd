<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1"  import="model.Video,java.util.*" %>
<!DOCTYPE html>
<html lang="en">
  ...
  <main id="main">
    ...
    <section id="pricing" class="pricing">
      <div class="container">
         ...
         System.out.println(VideoDbList);  
...
<div class="table-responsive">
  ...
  for(int i=0;i<1;i++)
   {%>
    ...
    <td ><%=myArray[2]%></td>
    <td ><%=myArray[3]%></td>
    <td ><a href="Delete.jsp?id=<%=myArray[0]%>&table=<%="video"%>"><button type="button" class="button2">Delete</button></a></td>
  </tr>
  <%
   }} %> 
